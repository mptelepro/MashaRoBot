...
def Masha_about_callback(update, context):
    ...
    if query.data == "masha_":
        query.message.edit_text(
            text=""" ℹ️ I'm *jin_jin_robot*, a powerful group management bot built to help you manage your group easily.
                 ...
                 \nHere is the [💾Repository](https://t.me/munnipopz).
                 \n\nIf you have any question about Masha, let us know at @mpazaanbot.""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
